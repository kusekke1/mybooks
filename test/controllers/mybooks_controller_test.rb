...
class MybooksControllerTest < ActionController::TestCase
  ...
  test "should create mybook" do
    assert_difference('Mybook.count') do
      post :create, mybook: { author: @mybook.author, book_name: @mybook.book_name, price: @mybook.price, publisher: @mybook.publisher, release: @mybook.release }
    end
  ...
  test "should update mybook" do
    patch :update, id: @mybook, mybook: { author: @mybook.author, book_name: @mybook.book_name, price: @mybook.price, publisher: @mybook.publisher, release: @mybook.release }
    assert_redirected_to mybook_path(assigns(:mybook))
  end
